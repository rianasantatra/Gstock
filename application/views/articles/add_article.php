	...
	<div class="container">
		...
		<form action="<?php echo site_url('paoma/add_article'); ?>" method="POST">
			...
			<div class="row">
				...
				<div class="col-md-3 form-group">
					<label for="">Envoyer le *</label>
					<input type="date" class="form-control" name="envoi" required>
				</div>
				<div class="col-md-3 form-group">
					<label for="">Réintégration nle *</label>
					<input type="date" class="form-control" name="reintegration" required>
				</div>
			</div>
